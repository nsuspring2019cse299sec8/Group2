    ...
    <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse custom_navbar" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item custom_nav">
                        <a class="nav-link " href="Docreg.php">Doctor Registration</a>
                    </li>
            ...
            <div class="container page-intro--red">
               <div class="wrapper">
                <div class="page-intro__content">
                    ...
                    <a class="page-intro__btn btn" href="booking2.html" target="_top">Book Now</a>
                </div>
            </div>
            </div>
        </div>
               ...
               <div class="row">
                ...
                <div class="col-md-3 column">
                    <div>
                        ...
                        <div class="join_team">
                            ...
                            <div>
                                <p class="custom_2nd"><span>If you want Emergency help</span></p>
                            </div>
                            <a class="btn custom_btn"  target="_top">Contact now</a>
                        </div>
                ...
                <div class="col-md-3 column">
                    <div>
                        ...
                        <div class="join_team">
                            <h3>Which Hospital You want?</h3>
                            <div class="text">
                                <form name="frmSearch" method="post" action="" id="">
                                    <fieldset class="form__fieldset">
                                        <div class="form__item">
                                            <label class="form__label" for="txtLocation" hidden>Find a location</label>
                                            <input class="custom_input" id="txtLocation" name="txtLocation" placeholder="" type="text" />
                                        </div>
                                        <input class="btn custom_btn" type="submit" id="ibtnSubmit" value="Search">
                                    </fieldset>
                                </form>
                            </div>
                        </div>
